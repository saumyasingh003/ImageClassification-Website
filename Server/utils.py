...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier(
        r"C:\Users\saumy\PycharmProjects\ImageClassification Project\Model\opencv\py-DataScience-CelebrityFaceRecognition-model-opencv\haarcascades\haarcascade_frontalface_default.xml")
    eye_cascade = cv2.CascadeClassifier(
        r"C:\Users\saumy\PycharmProjects\ImageClassification Project\Model\opencv\py-DataScience-CelebrityFaceRecognition-model-opencv\haarcascades\haarcascade_eye.xml")
